...
import { setGlobalName } from '_store/actions/index';
...
const Home = (props) => {
    ...
    return (
        <div className="home">
            <h4>home</h4>
            <Button onClick={changeName}>setGlobalName</Button>
...
export default connect((state) => ({ itemData: state.getGlobalData }), mapToProps)(Home);
